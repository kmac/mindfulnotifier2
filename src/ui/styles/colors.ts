...
const Colors = {
  light: {
    ...
    orange: {
      primary: 'rgb(205, 115, 85)',
      onPrimary: 'rgb(255, 255, 255)',
      primaryContainer: 'rgb(255, 230, 220)',
      onPrimaryContainer: 'rgb(70, 35, 20)',
    ...
    red: {
      primary: 'rgb(175, 90, 115)',
      onPrimary: 'rgb(255, 255, 255)',
      primaryContainer: 'rgb(255, 230, 235)',
      onPrimaryContainer: 'rgb(60, 25, 35)',
    ...
    violet: {
      primary: 'rgb(150, 110, 165)',
      onPrimary: 'rgb(255, 255, 255)',
      primaryContainer: 'rgb(245, 230, 250)',
      onPrimaryContainer: 'rgb(55, 35, 65)',
    ...
    indigo: {
      primary: 'rgb(120, 105, 175)',
      onPrimary: 'rgb(255, 255, 255)',
      primaryContainer: 'rgb(235, 230, 250)',
      onPrimaryContainer: 'rgb(40, 35, 75)',
    ...
    blue: {
      primary: 'rgb(75, 130, 170)',
      onPrimary: 'rgb(255, 255, 255)',
      primaryContainer: 'rgb(220, 235, 245)',
      onPrimaryContainer: 'rgb(25, 45, 65)',
    ...
    teal: {
      primary: 'rgb(70, 135, 145)',
      onPrimary: 'rgb(255, 255, 255)',
      primaryContainer: 'rgb(210, 240, 245)',
      onPrimaryContainer: 'rgb(20, 50, 55)',
    ...
    cyan: {
      primary: 'rgb(65, 140, 130)',
      onPrimary: 'rgb(255, 255, 255)',
      primaryContainer: 'rgb(205, 240, 230)',
      onPrimaryContainer: 'rgb(20, 50, 45)',
    ...
    green: {
      primary: 'rgb(75, 135, 85)',
      onPrimary: 'rgb(255, 255, 255)',
      primaryContainer: 'rgb(215, 240, 220)',
      onPrimaryContainer: 'rgb(25, 50, 30)',
    ...
    sage: {
      primary: 'rgb(110, 135, 90)',
      onPrimary: 'rgb(255, 255, 255)',
      primaryContainer: 'rgb(220, 235, 210)',
      onPrimaryContainer: 'rgb(35, 50, 25)',
    ...
    olive: {
      primary: 'rgb(130, 125, 80)',
      onPrimary: 'rgb(255, 255, 255)',
      primaryContainer: 'rgb(235, 230, 200)',
      onPrimaryContainer: 'rgb(45, 45, 25)',
    ...
    brown: {
      primary: 'rgb(165, 105, 85)',
      onPrimary: 'rgb(255, 255, 255)',
      primaryContainer: 'rgb(255, 230, 220)',
      onPrimaryContainer: 'rgb(55, 35, 25)',
    ...
    black: {
      ...
      onPrimary: 'rgb(255, 255, 255)',
      primaryContainer: 'rgb(240, 240, 240)',
      onPrimaryContainer: 'rgb(50, 50, 50)',
      ...
      onTertiaryContainer: 'rgb(45, 45, 45)',
      error: 'rgb(255, 180, 171)',
      onError: 'rgb(105, 0, 5)',
      errorContainer: 'rgb(147, 0, 10)',
      onErrorContainer: 'rgb(255, 180, 171)',
      ...
      inversePrimary: 'rgb(150, 150, 150)',
      elevation: {
        level0: 'transparent',
  ...
  dark: {
    ...
    orange: {
      primary: 'rgb(235, 170, 145)',
      onPrimary: 'rgb(60, 35, 20)',
      primaryContainer: 'rgb(135, 80, 60)',
      onPrimaryContainer: 'rgb(255, 230, 220)',
    ...
    red: {
      primary: 'rgb(220, 160, 175)',
      onPrimary: 'rgb(55, 25, 35)',
      primaryContainer: 'rgb(130, 70, 90)',
      onPrimaryContainer: 'rgb(255, 230, 235)',
    ...
    violet: {
      primary: 'rgb(195, 170, 205)',
      onPrimary: 'rgb(50, 35, 60)',
      primaryContainer: 'rgb(105, 75, 120)',
      onPrimaryContainer: 'rgb(245, 230, 250)',
    ...
    indigo: {
      primary: 'rgb(170, 160, 200)',
      onPrimary: 'rgb(35, 30, 65)',
      primaryContainer: 'rgb(85, 75, 125)',
      onPrimaryContainer: 'rgb(235, 230, 250)',
    ...
    blue: {
      primary: 'rgb(145, 175, 200)',
      onPrimary: 'rgb(20, 40, 60)',
      primaryContainer: 'rgb(55, 95, 125)',
      onPrimaryContainer: 'rgb(220, 235, 245)',
    ...
    teal: {
      primary: 'rgb(130, 180, 190)',
      onPrimary: 'rgb(20, 45, 50)',
      primaryContainer: 'rgb(50, 100, 110)',
      onPrimaryContainer: 'rgb(210, 240, 245)',
    ...
    cyan: {
      primary: 'rgb(125, 185, 175)',
      onPrimary: 'rgb(20, 45, 40)',
      primaryContainer: 'rgb(50, 105, 95)',
      onPrimaryContainer: 'rgb(205, 240, 230)',
    ...
    green: {
      primary: 'rgb(130, 180, 140)',
      onPrimary: 'rgb(20, 45, 25)',
      primaryContainer: 'rgb(50, 100, 60)',
      onPrimaryContainer: 'rgb(215, 240, 220)',
    ...
    sage: {
      primary: 'rgb(160, 185, 145)',
      onPrimary: 'rgb(30, 45, 25)',
      primaryContainer: 'rgb(75, 105, 65)',
      onPrimaryContainer: 'rgb(220, 235, 210)',
    ...
    olive: {
      primary: 'rgb(175, 170, 125)',
      onPrimary: 'rgb(40, 40, 25)',
      primaryContainer: 'rgb(95, 90, 60)',
      onPrimaryContainer: 'rgb(235, 230, 200)',
    ...
    brown: {
      primary: 'rgb(225, 170, 145)',
      onPrimary: 'rgb(50, 35, 25)',
      primaryContainer: 'rgb(115, 75, 60)',
      onPrimaryContainer: 'rgb(255, 230, 220)',
    ...
    black: {
      ...
      onTertiaryContainer: 'rgb(235, 235, 235)',
      error: 'rgb(255, 180, 171)',
      onError: 'rgb(105, 0, 5)',
      errorContainer: 'rgb(147, 0, 10)',
      onErrorContainer: 'rgb(255, 180, 171)',
