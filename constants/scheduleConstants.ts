...
export function getMinIntervalMinutes(): number {
  if (Platform.OS === "android") {
    return __DEV__ ? 4 : ANDROID_MIN_INTERVAL_MINUTES;
  }
  return WEB_MIN_INTERVAL_MINUTES;
}
